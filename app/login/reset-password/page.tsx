    ...
    return (
        <section className="flex flex-col items-center justify-center min-h-[70vh] py-10 px-5 bg-[#122117] text-white space-y-5">
            ...
            <div className="w-full md:w-[500px] space-y-8">
                <PasswordInput value={userData.newPassword} onChange={handleNewPasswordChange} placeholder="New password" label="New password" isLabelShown={false} />
                <PasswordInput value={userData.confirmPassword} onChange={handleConfirmPasswordChange} placeholder="Confirm new password" label="Confirm new password" isLabelShown={false} />
